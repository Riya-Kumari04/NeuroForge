        ...
        <main className="flex-1 p-8 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <ComingSoonCard
              ...
              description="Real-time progress bars, milestone completion, and delivery status."
            ...
            <ComingSoonCard
              ...
              description="Interactive project roadmap with milestone and release tracking."
              module="Coming Soon — Module 3"
            />
          </div>

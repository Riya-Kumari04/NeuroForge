...
import { ShieldCheck, Users, Briefcase, Bell, Lock, Bug, FileCode2, BarChart2 } from 'lucide-react';

const notifications = [
  { id: 1, type: 'role', message: 'Your role has been set to QA Tester by Org Admin', time: '2 hours ago', read: false },
  { id: 2, type: 'invite', message: 'You were added to project "Phoenix v2.0"', time: '4 hours ago', read: false },
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 ml-64 flex flex-col">
        <DashboardNavbar title="Quality Assurance Center" />
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          ...
          <div className="mb-8 bg-emerald-500/5 border border-emerald-500/20 rounded-xl px-6 py-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">You are logged in as QA Tester. Your account and role are active.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <ComingSoonCard
              ...
              description="Create, organise, and execute test cases across all projects."
              module="Coming Soon — Module 5"
            />
            <ComingSoonCard
              icon={Bug}
              title="Bug Tracker"
              description="Log, triage, and track bugs with severity levels and status flow."
              module="Coming Soon — Module 5"
            />
            <ComingSoonCard
              icon={BarChart2}
              title="QA Analytics & Reports"
              description="Test coverage metrics, pass/fail trends, and automated test results."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-card border border-border rounded-xl p-6 shadow-sm flex flex-col">
              ...
              <div className="relative border-l border-border/50 ml-3 flex-1 space-y-6">
                {[
                  { action: 'Logged in successfully', time: '5 mins ago', type: 'login' },
                  { action: 'Role assigned: QA Tester', time: '2 hours ago', type: 'role' },
                  { action: 'Added to project Phoenix v2.0', time: '4 hours ago', type: 'project' },
              ...
              <div className="mt-6 pt-4 border-t border-border">
                <div className="flex items-center gap-2 p-3 bg-background rounded-lg border border-dashed border-border">
                  ...
                  <div>
                    <p className="text-xs font-medium text-slate-400">Verification Queue</p>
                    <p className="text-[10px] text-muted-foreground">Coming Soon — Module 5</p>
                  </div>
                </div>
              </div>
            </div>

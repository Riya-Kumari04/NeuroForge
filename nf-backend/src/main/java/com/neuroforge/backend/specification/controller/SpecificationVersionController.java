...
public class SpecificationVersionController {
    ...
    public ResponseEntity<ApiResponse<List<SpecificationVersionResponse>>> getVersions(
        ...
        return ResponseEntity.ok(ApiResponse.ok("Versions fetched successfully", response));
    }
    ...
    public ResponseEntity<ApiResponse<SpecificationVersionResponse>> getVersion(
        ...
        return ResponseEntity.ok(ApiResponse.ok("Version fetched successfully", response));
    }
    ...
    public ResponseEntity<ApiResponse<SpecificationVersionResponse>> getLatestVersion(
        ...
        return ResponseEntity.ok(ApiResponse.ok("Latest version fetched successfully", response));
    }

    @PostMapping("/{id}/versions/create")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPER_ADMIN', 'ROLE_ORG_ADMIN', 'ROLE_PROJECT_MANAGER')")
    public ResponseEntity<ApiResponse<SpecificationVersionResponse>> createNewVersion(
            @PathVariable UUID id) {

        log.info("HTTP Request received | Create New Version | specificationId={}", id);

        SpecificationVersionResponse response =
                versionService.createNewVersion(id);

        log.info("New version created successfully | specificationId={} | version={}", id, response.getVersionNumber());

        return ResponseEntity.ok(ApiResponse.ok("New version created successfully", response));
    }
    ...
    public ResponseEntity<ApiResponse<SpecificationVersionResponse>> submitForReview(
        ...
        return ResponseEntity.ok(ApiResponse.ok("Version submitted for review successfully", response));
    }
    ...
    public ResponseEntity<ApiResponse<SpecificationVersionResponse>> approveVersion(
        ...
        return ResponseEntity.ok(ApiResponse.ok("Version approved successfully", response));
    }
    ...
    public ResponseEntity<ApiResponse<SpecificationVersionResponse>> rejectVersion(
        ...
        return ResponseEntity.ok(ApiResponse.ok("Version rejected successfully", response));
    }
    ...
    public ResponseEntity<ApiResponse<SpecificationVersionResponse>> archiveVersion(
        ...
        return ResponseEntity.ok(ApiResponse.ok("Version archived successfully", response));
    }
    ...
    public ResponseEntity<ApiResponse<CompareVersionResponse>> compareVersions(
        ...
        return ResponseEntity.ok(ApiResponse.ok("Versions compared successfully", response));
    }
    ...
    public ResponseEntity<ApiResponse<SpecificationVersionResponse>> updateDraftVersion(
        ...
        return ResponseEntity.ok(ApiResponse.ok("Draft version updated successfully", response));
    }
